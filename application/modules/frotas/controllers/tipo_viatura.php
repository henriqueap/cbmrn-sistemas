...
class Tipo_viatura extends MX_Controller {
  ...
  function __construct() {
    parent::__construct();
    $this->load->model('tipo_viatura_model');
  }

  public function cadastro($data = ''){
    $viaturas = $this->tipo_viatura_model->listaTipo();
  	$tipo_viatura = $this->load->view('tipo_viatura/cadastro', array('data' => $data , 'listar_viaturas' => $viaturas), TRUE);
