            ...
            <div class="panel-body">
              <table class="table table-striped table-responsive">
                ...
                <tr>
    						  ...
    						  <td>
                    <a type="button" class="btn btn-info btn-xs" title="Editar" href="<?php echo base_url('frotas/tipo_servico/editar').'/'.$servicos->id;?>">
                  ...
                  <?php if ($servicos->ativo==1) { ?>
     						  <td>
                    <a type="button" data-toggle="modal" data-target="#myModal-desativar-tipo-servico" class="btn btn-danger btn-xs" onclick="confirmarDesativarTipoServico('<?php echo base_url('index.php/frotas/tipo_servico/testes').'/'.$servicos->id; ?>')">
                      <span title="Desativar serviço" class="glyphicon glyphicon-remove"></span>
                    </a>
                  </td>
                  <?php } else { ?>
                  <td>
                    <a type="button" data-toggle="modal" data-target="#myModal-reativar-tipo-servico" class="btn btn-success btn-xs" onclick="confirmarReativarTipoServico('<?php echo base_url('index.php/frotas/tipo_servico/testes').'/'.$servicos->id; ?>')">
                      <span title="Reativar serviço" class="glyphicon glyphicon-ok"></span>
                    </a>
                  </td>
                  <?php } ?>
                </tr>
