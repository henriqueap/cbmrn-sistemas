						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group  ">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
										<select class="form-control" id="selMarca" name="selMarca">
											<?php 
											//if(!isset($data->marca_veiculos_id) == FALSE): ?>
													...
													//else: ?>   
														...
														<?php
														foreach($listar_marcas->result() as $marcas) : 
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
									<center>
										<button type="submit" class="btn btn-success" id="btnSalvarModelo">Salvar</button>
									</center>
								</div>
							</div>                        
						</div>
						...
						<div class="panel-body">
							<table class="table table-striped table-responsive">
								...
								<tr>
									...
									<td>
										<a type="button" class="btn btn-info btn-xs" title="Editar" href="<?php echo base_url('index.php/frotas/modelos_marcas/editar').'/'.$modelo->id . '/' ; ?>">
									...
									<td>
										<a type="button" data-toggle="modal" data-target="#myModal-desativar-tipo-modelo" class="btn btn-success btn-xs center" onclick="confirmarDesativarTipoModelo('<?php echo base_url('index.php/frotas/modelos_marcas/testes').'/'.$modelo->id; ?>')">
											<span title="Desativar modelo" class="glyphicon glyphicon-ok"></span>
										</a>
									</td>
									<?php } else { ?>
										<td>
											<a type="button" data-toggle="modal" data-target="#myModal-reativar-tipo-modelo" class="btn btn-danger btn-xs center" onclick="confirmarReativarTipoModelo('<?php echo base_url('index.php/frotas/modelos_marcas/testes').'/'.$modelo->id; ?>')">
												<span title="Reativar modelo" class="glyphicon glyphicon-remove"></span>
											</a>
										</td>  
									<?php } ?>
								</tr>
