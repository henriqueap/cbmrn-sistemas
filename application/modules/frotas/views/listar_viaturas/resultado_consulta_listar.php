            ...
            <tr>
                ...
                if($listar->viaturasAtivo==1){
                    ...
                    <!-- Tentar fazer modal funcionar aqui --> 
                        <a title="Excluir viatura" type="button" <?php /*?>type="button" data-toggle="modal" data-target="#myModal-excluir"<?php */?> class="btn-xs btn-success" <?php /*?>onclick="confirmarExcluir('<?php echo base_url('index.php/frotas/listar_viaturas/excluir').'/'.$listar->idviaturas;?>')"<?php */?> href="<?php echo base_url('index.php/frotas/listar_viaturas/excluir').'/'.$listar->idviaturas;?>">
                    ...
                    <td><a title="Listar odômetros da viatura" type="button" class=" btn-xs btn-default " href="<?php echo base_url('index.php/frotas/listar_viaturas/listarOdometros').'/'.$listar->idviaturas;?>"><span title="Histórico de Odômetro" class="glyphicon glyphicon-map-marker"></span></a></td>
                <?php } else {?>
                    <td title="Função desabilitada"></td>
                    <td title="Função desabilitada"></td>
                                                
                    <td>
                        <a title="Reativar viatura" <?php /*?>type="button" data-toggle="modal" data-target="#myModal-reativar"<?php */?> class="btn-xs btn-danger" <?php /*?>onclick="confirmarExcluir('<?php echo base_url('index.php/frotas/listar_viaturas/excluir').'/'.$listar->idviaturas;?>')"<?php */?> href="<?php echo base_url('index.php/frotas/listar_viaturas/excluir').'/'.$listar->idviaturas;?>"><span class="glyphicon glyphicon-ok"></span>
                        </a>
                    </td>
                    <td>
