                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-responsive">
                                ...
                                <tr>
              					    ...
              					    <td>
                                        <a type="button" class="btn btn-info btn-xs" href="<?php echo base_url('frotas/tipo_viatura/editar').'/'.$viaturas->id ?>" > 
                                    ...
                                    <?php if ($viaturas->ativo==1) { ?>
               						<td>
                                        <a type="button" data-toggle="modal" data-target="#myModal-desativar-tipo-viatura" class="btn btn-danger btn-xs" onclick="confirmarDesativarTipoViatura('<?php echo base_url('frotas/tipo_viatura/testes').'/'.$viaturas->id; ?>')">
                                          <span title="Desativar viatura" class="glyphicon glyphicon-remove"></span>
                                        </a>
                                      </td>
                                      <?php } else { ?>
                                      <td>
                                        <a type="button" data-toggle="modal" data-target="#myModal-reativar-tipo-viatura" class="btn btn-success btn-xs" onclick="confirmarReativarTipoViatura('<?php echo base_url('frotas/tipo_viatura/testes').'/'.$viaturas->id; ?>')">
                                          <span title="Reativar viatura" class="glyphicon glyphicon-ok"></span>
                                        </a>
                                      </td>
                                   <?php } ?>
                                </tr>
