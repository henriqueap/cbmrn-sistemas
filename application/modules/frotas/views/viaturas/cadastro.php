        ...
        <div class="panel-body"> 
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                        <input type="text" rel="prefixo" class="form-control" style="text-transform: uppercase" rel="prefixo" id="txtPrefixo" name="txtPrefixo" placeholder="Ex: L-04" required>
                  </div>    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                         <input type="text" class="form-control" rel="renavam" id="txtRenavam" rel="renavam" name="txtRenavam" placeholder="Ex: 76455596-1" required>
                  </div>    
                </div>
