          ...
          <div class="panel panel-danger">
            ...
            <div class="panel-body">
              <table class="table table-striped table-responsive">
                ...
                <tr>
    						  <td><?php echo $cont++; ?></td>
     						  <td><?php echo $marcas->nome; ?></td>
    						  <td>
                    <a type="button" class="btn btn-info btn-xs" title="Editar" href="<?php echo base_url('frotas/marcas_veiculos/editar').'/'.$marcas->id; ?>">
                  ...
                  <?php if ($marcas->ativo==1) { ?>
     						  <td>
                    <a type="button" data-toggle="modal" data-target="#myModal-desativar-tipo-marca" class="btn btn-danger btn-xs" onclick="confirmarDesativarTipoMarca('<?php echo base_url('frotas/marcas_veiculos/testes').'/'.$marcas->id; ?>')">
                      <span title="Desativar marca" class="glyphicon glyphicon-remove"></span>
                    </a>
                  </td>
                  <?php } else { ?>
                  <td>
                    <a type="button" data-toggle="modal" data-target="#myModal-reativar-tipo-marca" class="btn btn-success btn-xs" onclick="confirmarReativarTipoMarca('<?php echo base_url('frotas/marcas_veiculos/testes').'/'.$marcas->id; ?>')">
                      <span title="Reativar marca" class="glyphicon glyphicon-ok"></span>
                    </a>
                  </td>  
                    <?php } ?>
                </tr>
