					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">                      
						<div class="pull-right">
							<ul class="ulUser">
								...
								<li>Sd Pereira</li><!-- Alterar  depois para puxar o nome do usuário -->
								<li>|</li>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><?php echo anchor('frotas/odometro/cadastro', 'Odômetro'); ?></li> 
									...
									<li><?php echo anchor('frotas/tipo_odometro/cadastro', 'Tipo Odometro'); ?></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><?php echo anchor('frotas/servicos_cancelados_autorizados/listar', 'Serviços cancelados ou não autorizados'); 
								*/	?></li> -->
