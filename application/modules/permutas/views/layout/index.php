			...
			<div class="container" >
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
						...
						<div>
							<h3>Sistema de Controle de Permutas</h3>
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							<li><?php echo anchor('permutas', 'Início'); ?></li>
							<li class="dropdown">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><?php echo anchor('saude/carregar_csv', 'Odontologia'); ?></li>
									<li><?php echo anchor('saude/listar_permutas', 'Medicina', array('title' => 'Listar permutas cadastradas no sistema')); ?></li>
									<li><?php echo anchor('saude/listar_permutas', 'Fisioterapia', array('title' => 'Listar permutas cadastradas no sistema')); ?></li>
								</ul>
							</li>
						</ul>
					</div><!--/.nav-collapse -->
