            ...
            <div class="container" >
                <dafastamentosss="row">
                    <div class="col-lg-9  col-md-9 col-sm-9 col-xs-9">
                        ...
                        <div>
                            <h3>Boletins Gerais - Sistema de Publicação</h3> 
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><?php echo anchor('publico/publico', 'Início'); ?></li>
                            
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Boletins Gerais <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><?= anchor('publico/cadastro', 'Criar Boletim', array('title'=>'Criar Boletim'));?></li>
                                    <li><?= anchor('publico/listarBoletins', 'Boletins Gerais', array('title'=>'Boletins Gerais'));?></li>
                                    <li><?= anchor('publico/consultar', 'Consultar Boletins', array('title'=>'Consultar Boletins'));?></li>
                                    <li><?= anchor('publico/viewExcluir', 'Excluir Boletins', array('title'=>'Excluir Boletins'));?></li>
                                </ul>
                            </li> <!--/.dropdown-->                  
                    </div><!--/.nav-collapse -->
                </div>     
