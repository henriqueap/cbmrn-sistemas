$(function() {
    ...
    // Filtro de dados em odometro
     $("#btn-buscar-filtro").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/listar_viaturas/listarOdometrosFiltrar/',
            type: 'get',
            data: {
    ...
    // Filtro de dados em abastecimento
     $("#btn-buscar-filtro-abastecimento").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/listar_viaturas/listarAbastecimentosFiltrar/',
            type: 'get',
            data: {
                id:$("#inputIdViaturas").val(),
                data_inicial: $("#dataInicial").val(), 
    ...
    //filtro de dados em Servicos
     $("#btn-buscar-filtro-servicos").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/listar_viaturas/listarServicosFiltrar/',
            type: 'get',
            data: {
                id:$("#inputIdViaturas").val(),
                idTipo:$("#selTipo").val(),
    ...
    // Filtro de dados em Listar geral
     $("#btn-buscar-filtro-viaturas").click(function(event) {
       $.ajax({
            url: BASE_URL + 'index.php/frotas/listar_viaturas/listarFiltrar/',
            type: 'get',
            data: {
    ...
    // Filtro de dados em relatorio geral
     $("#btn-buscar-filtro-relatorio").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/relatorio_geral/relatorioFiltrar/',
            type: 'get',
            data: {
                /* idViatura:$("#idViatura").val(), */
                idLotacao:$("#selLotacao").val(),
     ...
     $("#btn-buscar-filtro-concluidos").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/servicos_concluidos/listarFiltrar/',
            type: 'get',
            data: {
    ...
    $("#btn-buscar-filtro-pendentes").click(function(event) {
       $.ajax({
            url: BASE_URL + 'index.php/frotas/servicos_pendentes/listarFiltrar/',
            type: 'get',
            data: {
                data_inicio: $("#dataInicial").val(), 
                data_fim: $("#dataFinal").val(),  
    ...
    $("#btn-buscar-filtro-cancelados-nao-autorizados").click(function(event) {
        $.ajax({
            url: BASE_URL + 'index.php/frotas/servicos_cancelados_autorizados/listarFiltrar/',
            type: 'get',
            data: {
                intTipo: $("#intTipo").val(), 
                data_inicio: $("#dataInicial").val(), 
    ...
    $('#autorizacao').click(function () { $("#autorizacaoModal").show(); });
    $('#dadosEndereco').hide();
    $('#loader').hide();
    ...
    $("#selMarca").change(function(){
        $.ajax({
            type: 'get', 
            url: BASE_URL + 'index.php/frotas/viaturas/carregaModelos/', 
            data: {
                marca: $("#selMarca").val()
            },
            success: function(result) {
    ...
    $("#btn-concluir-nota").click(function(event) {
        $.ajax({
            ...
            fail: function(result) { $("body").html(result); }
        });
    }); 
...
// Função que exibe Modal generico para ativar 
function confirmarDesativar(url) {
    $("#bt-modal-confirmar-desativar").attr('href', url);
}

// Função que exibe Modal generico para reativar 
function confirmarReativar(url) {
