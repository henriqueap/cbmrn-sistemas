			...
			if ($this->form_validation->run() == TRUE) {
				...
				if (empty($array_post['id'])) {
					...
					if (! $grupo) {
						# Bloco de auditoria
							$auditoria = array(
												'auditoria'=>'Tentativa de incluir novo grupo de produtos no sistema',
												'idmilitar'=>$this->session->userdata['id_militar'], #Checar quem está acessando e permissões
												'idmodulo'=>$this->session->userdata['sistema']
											);
						...
						# Bloco de auditoria
							$auditoria = array(
												'auditoria'=>'Incluiu novo grupo de produtos no sistema',
												'idmilitar'=>$this->session->userdata['id_militar'], #Checar quem está acessando e permissões
												'idmodulo'=>$this->session->userdata['sistema']
											);
							$this->clog_model->audita($auditoria, 'inserir');
					...
					if (! $grupos) {
						# Bloco de auditoria
							$auditoria = array(
												'auditoria'=>'Tentativa de alterar o grupo de produtos ID n° '.$id.', no sistema',
												'idmilitar'=>$this->session->userdata['id_militar'], #Checar quem está acessando e permissões
												'idmodulo'=>$this->session->userdata['sistema']
											);
						...
						# Bloco de auditoria
							$auditoria = array(
												'auditoria'=>'Alterou o grupo de produtos ID n° '.$id.', no sistema',
												'idmilitar'=>$this->session->userdata['id_militar'], #Checar quem está acessando e permissões
												'idmodulo'=>$this->session->userdata['sistema']
											);
							$this->clog_model->audita($auditoria, 'inserir');
