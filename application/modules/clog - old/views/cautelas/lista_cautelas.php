										...
										<tr>
											...
											<td><?php 
												if (is_null($cautela->data_conclusao)) { # Checar se é o melhor caminho
													if ($cautela->data_prevista > date("Y-m-d", strtotime("now"))) echo "<font color='green'><b>".$cautela->data_prevista_fmt."</b></font>";
													else if ($cautela->data_prevista == date("Y-m-d", strtotime("now"))) echo "<font color='orange'><b>".$cautela->data_prevista_fmt."</b></font>";
													else echo "<font color='red'><b>".$cautela->data_prevista_fmt."</b></font>";
												}
												else echo "$cautela->data_conclusao"; ?>
											</td>
											<td>
												<?php
