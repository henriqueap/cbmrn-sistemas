...
<html lang="pt-br">
	<head>
		...
		<title><?php echo ($cautela->distribuicao == 1) ? "Termo de Distribuição de Material" : "Termo de Cautela de Material"; ?></title>
			...
			<div class="container" >
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="center">
							<h4><?php echo ($cautela->distribuicao == 1) ? "Termo de Distribuição de Material" : "Termo de Cautela de Material"; ?></h4>
						</div>
					</div>
					<hr>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<p>
							...
							<b>Setor:</b> <?php echo $cautela->setor." - ".$cautela->sigla; ?><br />
						</p>
						<hr>
										...
										if (isset($itens) && (! is_bool($itens))) {
											...
											foreach($itens->result() as $item):
												if (is_null($item->tombo_id)) { ?>
													<tr>
														...
														<?php 
														if ($cautela->distribuicao == 0) echo "<td>".$cautela->data_prevista."</td>"; 
											...
											if (isset($tombos)) {
												foreach($tombos->result() as $tombo):
													if (! isset($item_permanente["$tombo->modelo"])) $item_permanente["$tombo->modelo"] = $tombo->tombo.";";
													else $item_permanente["$tombo->modelo"] .= " ".$tombo->tombo.";";
												endforeach;
											}
											...
											foreach($item_permanente as $modelo => $numeros): ?>
												<tr>
													...
													if ($cautela->concluida == 1) {
														echo "<td>".$cautela->data_conclusao." ".$item->hora_conclusao."</td>";
													} ?>
												</tr>
												<?php
											endforeach;
