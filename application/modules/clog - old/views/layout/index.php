						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><?php echo anchor('clog/notas/index', 'Notas Fiscais', array('title'=>'Cadastro de Notas Fiscais')); ?></li>
									...
									<li><?php echo anchor('clog/cautelas/transferencia_patrimonio', 'Transferência de Patrimônio', array('title'=>'Transferência de Patrimônio')); ?></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><?php echo anchor('clog/cautelas/consulta_distros', 'Distribuição', array('title'=>'Consulta de Cautelas')); ?></li>
								</ul>
							</li> <!--/.dropdown-->
		...
		<script type="text/javascript">
			(function ($) {
				...
				$.extend($.fn.select2.defaults, {
				  ...
				  formatInputTooLong: function (input, max) { var n = input.length - max; return "Remova " + n + " caractere" + (n == 1? "" : "s"); },
				  formatSelectionTooBig: function (limit) { return "Só é possível selecionar " + limit + " cliente." + (limit == 1 ? "" : "s"); },
