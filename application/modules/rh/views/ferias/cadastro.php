...
<div class="container">
		<div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12">
						<h1><?php echo (!isset($data->id)) ? 'Cadastro de Turma de Férias' : 'Editar Turma de Férias'; ?></h1>
						<hr />
						...
						<div class="form-group">
								...
								<div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
										<input type="text" name="exercicio" class="form-control" id="exercicio" value="<?php echo date('Y') - 1; ?>" placeholder=""/>
								</div>
						</div>
