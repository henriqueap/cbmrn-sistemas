...
<div class="container">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <h1><?= (!isset($data->id)) ? 'Cadastro de Afastamentos' : 'Editar Afastamentos'; ?></h1>
        <hr />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xs-12">
                <select name="tipo_afastamentos_id" class="form-control" id="tipo_afastamentos_id">
                    ...
                    <option value="<?php echo $afastamentos->id; ?>"><?php echo $afastamentos->nome." - ".$afastamentos->dias." Dias "; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
