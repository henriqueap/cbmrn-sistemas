			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="#" method="post" class="form-horizontal" role="form"> 
						...
						<div class="form-group">
							<label for="ano_nota" class="col-sm-2 control-label">Ano</label>
							<div class="col-sm-12 col-md-3 col-lg-3 col-xs-12">
								<input type="text" name="ano_nota" id="ano_nota" class="form-control xs-input" rel="ano" placeholder="Ano da Nota">
							</div>
						</div> <!-- .form-group -->
