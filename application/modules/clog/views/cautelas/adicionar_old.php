<div class="container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><?php echo ($cautela->distribuicao == 1) ? "Termo de Entrega" : "Cautela"; ?> de Material</h3>
				</div>
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="produtos" class="col-xs-12 col-sm-12 col-md-2 col-lg-2 control-label">Produtos</label>
					...
					<input type="hidden" id="quantidade_input" value="">     
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<h1><?php echo ($cautela->distribuicao == 1) ? "Termo de Entrega" : "Cautela de Material"; ?> - Visualização</h1>
		</div>
		<hr>
				...
				<div class="panel panel-default">
						<div class="panel-body">
										...
										if (isset($itens) && (! is_bool($itens))) {
												...
												<tr>
														...
														<td>
																...
																<input type="button" name="btnCancela" id="btnCancela" value="Cancelar Item" onclick="location.href = '<?php echo BASE_URL('index.php/clog/cautelas/cancelar_item').'?id='.$item->item_id; ?>'">
																<?php 
																} ?>
														</td>
												</tr>
								...
								<div class="col-sm-3 col-md-6 col-lg-6 col-xs-3 ">
									<button type="button" class="btn btn-default" onclick="location.href = '<?php echo BASE_URL('index.php/clog/cautelas/cautelar').'?id='.$cautela->id; ?>';">Gerar <?php echo ($cautela->distribuicao == 1) ? "Termo de Entrega" : "Cautela"; ?></button>
								</div> 
						</div>
