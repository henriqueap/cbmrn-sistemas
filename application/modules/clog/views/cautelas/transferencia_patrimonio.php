<div class="container">
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<h1>Transferência de Material Permanente</h1>
			<hr>
		</div>
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
				...
				<div class="panel-body">
					<?php echo form_open('clog/cautelas/salvar_cautela', array('role'=>'form', 'class'=>'form-horizontal')); ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-2 col-lg-2 col-xs-12">
								<input type="text" name="tombo" id="tombo" class="form-control input-sm" placeholder="Nº Tombo" required="required" title="Colocar data prevista apenas se for empréstimo"/>
