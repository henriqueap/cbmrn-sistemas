<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h1>Material Transferido</h1></div>
		<hr>
								...
								foreach ($cautelas->result() as $cautela):
									if ($cautela->distribuicao > 0 && $cautela->ativa == 1 /* && is_null($cautela->data_conclusao) === TRUE */) { ?>
										<tr>
											...
											<td class="center"><?php echo (is_null($cautela->sigla)) ? "-" : $cautela->sigla; ?></td>
											...
											<td>
												...
												<input type="button" name="btnCancela" id="btnCancela" value="Cancelar" title="Cancelar a Transferência" onclick="location.href = '<?php echo BASE_URL('index.php/clog/cautelas/cancelar_cautela') . '?id=' . $cautela->id; ?>'">
												<?php
												if ($sala == 1) { ?>
													<input type="button" name="btnDevolve" id="btnDevolve" value="Devolver" title="Devolver o material" onclick="location.href = '<?php echo BASE_URL('index.php/clog/cautelas/devolver_material') . '?id=' . $cautela->id; ?>'">
													<?php
												} ?>
											</td>
										</tr>
