<div class="container">
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<h1>Consulta de Saída de Material
				<?php
				switch ($tipo_saida) {
					case 1:
						echo " - Distribuição";
		...
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php
					echo form_open("clog/cautelas/filtra_cautela", array('role' => 'form', 'class' => 'form-horizontal'));
					# Militar
					if (isset($tipo_saida) && $tipo_saida < 2) { ?>
					...
					# Setor
						...
						<div class="form-group">
							<label for="setor_id" class="col-sm-2 control-label">Setor Destino</label>
							<div class="col-sm-12 col-md-2 col-lg-2 col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<?php if (isset($tipo_saida) && $tipo_saida == 0) { ?>
								<div class="checkbox">
									<input type="checkbox" name="concluida" value="0" checked><label for="concluida"> Em aberto</label>
								</div>
							<?php } 
							if (isset($tipo_saida) && $tipo_saida == 1) { ?>
								<div class="checkbox">
									<input type="checkbox" name="uso_distro" value="1" checked><label for="uso_distro"> Para militar</label>
								</div>
							<?php } ?>
						</div><!--.col-->
					</div><!--.form-group-->
