<div class="container">
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<h1>Consulta de Transferência de Material para Sala</h1>
			<hr>
		</div>
		<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php echo form_open("clog/cautelas/filtra_cautela?sala=1", array('role' => 'form', 'class' => 'form-horizontal'));
						# Militar
								...
								<div class="col-sm-12 col-md-2 col-lg-2 col-xs-12">
									<select name="setor_id" class="form-control" id="setor_id">
										...
										<?php foreach ($salas as $sala): ?>
											<option value="<?php echo $sala->id; ?>"><?php echo $sala->sigla; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-2">
								...
								<input type="hidden" class="form-control" id="distribuicao" name="distribuicao" value="2">
